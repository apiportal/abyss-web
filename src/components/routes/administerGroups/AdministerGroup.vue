<template>
  <div>
    <b-navbar toggleable="lg" type="dark" variant="secondary">
      <b-navbar-brand>{{ group.subjectname }}</b-navbar-brand>
      ...
      <b-collapse is-nav id="nav_collapse">
        ...
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item-dropdown right>
            ...
            <b-dropdown-item :to="`/app/administer-groups/${page}/logs/${group.uuid}/subject/1`">All</b-dropdown-item>
          </b-nav-item-dropdown>
          ...
          <b-nav-item-dropdown right>
            ...
            <b-dropdown-item :to="`/app/administer-groups/${page}/edit/${group.uuid}`"><Icon icon="edit" /> Edit Group</b-dropdown-item>
            <b-dropdown-item :to="`/app/administer-groups/${page}/delete/${group.uuid}`"><Icon icon="trash-alt" /> Delete Group</b-dropdown-item>
          </b-nav-item-dropdown>
        </b-navbar-nav>
      </b-collapse>
    </b-navbar>
